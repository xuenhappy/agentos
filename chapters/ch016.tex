...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle RepeatedCSOMigration
\longrightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle RepeatedUsefulStructureFlow
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LearningWhat
\rightarrow
LearningHow
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SlowVariableProtectionPrinciple:
\qquad
FastNoise
\nrightarrow
SlowGlobalStructure.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle StateAdaptation
\rightarrow
