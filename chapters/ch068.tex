...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.38\textheight,keepaspectratio]{images/functional-temporal-axis.png}
\caption{功能层级与时间层级的双轴架构}
\end{figure}
\begin{introduction}[本章导航]
  \item 功能层级与时间层级
  \item Agent-CSO 的双轴状态空间
  \item 向慢巩固与向快激活
  \item 异常上浮与能力下沉
\end{introduction}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PastExplicitProcessing
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ExplicitCognitiveControl
\rightarrow
RepeatedTrajectory
\rightarrow
StablePolicy
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PersistentImportantResidual
\Rightarrow
Promotion.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle RepeatedStableCSORelation
\Rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \begin{array}{ccc}
