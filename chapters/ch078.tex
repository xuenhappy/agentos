...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle StableStructure\downarrow,\qquad UnexpectedResidual\uparrow.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle DigitalClosure
\rightarrow
PhysicalClosure
\rightarrow
LifecycleClosure
