...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Complexity\ Migration
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Complexity_{explicit}
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle StableComplexity
\rightarrow
LowerLevelCarrier\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle StableCSO
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \omega_{\mathrm{fast}}
\rightarrow
\omega_{\mathrm{slow}}\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Consolidation:
Fast\rightarrow Slow\)}
\end{statementbox}

\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Activation:
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle C_{\mathrm{internal}}
\rightarrow
C_{\mathrm{external}}\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Conservation
\rightarrow
Lineage\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Complexity
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle CSO/AgentCSO
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle CSOMigration
