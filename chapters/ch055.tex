...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SGC
=
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.38\textheight,keepaspectratio]{images/SGC-respect.png}
\caption{SGC 的身体中心实现示意图}
\end{figure}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PersistentWorldIdentity
\leftrightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle EpistemicConflict
\rightarrow
ActiveReobservation.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \gamma_t:
AgentCSO
\rightarrow
SGCSubgraph.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \eta_t:
SGCSubgraph
\rightarrow
AgentCSO.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Image
\rightarrow
Scene
\rightarrow
PersistentWorld
