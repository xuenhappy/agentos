...
\caption{Kernel—KRA—BPCC 联合学习稳定性}
\end{figure}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Run
\rightarrow
Observe
\rightarrow
Accumulate
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \begin{minipage}{0.85\textwidth}
