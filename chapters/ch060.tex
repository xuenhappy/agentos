...
\caption{Kernel 全局预测与 BPCC 局部预测}
\end{figure}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle KernelPrediction
\rightarrow
Envelope
\rightarrow
ControlReference
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SlowPrediction
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Global Meaning}
\leftrightarrow
\text{Local Dynamics}
\leftrightarrow
\text{Reality}\)}
