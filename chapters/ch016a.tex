...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{CSO本体复杂度}
\neq
\text{Agent-CSO条件复杂度}.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{结构模型}+\text{时间残差}\)}
\end{statementbox}
中的后者。
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{实时展开}
\rightarrow
\text{轨迹残差压缩}
\rightarrow
\text{可复用生成压缩}.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \operatorname{ACSO}^{\mathrm{explicit}}
\longrightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PersistentCSOMigration
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FastCSOFlow
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SlowTopology
\rightarrow
FutureCSOFlow.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle RepresentationAdaptation
\rightarrow
CarrierMigration
\rightarrow
FunctionalMigration
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{短时立即需要}
\rightarrow
\text{在线展开},\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{尚未完全理解但值得保留}
\rightarrow
\text{经验轨迹},\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{跨情境重复规律}
\rightarrow
\text{生成结构},\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{重复行动模式}
\rightarrow
\text{技能},\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{内部长期维持不经济}
\rightarrow
\text{外部载体},\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{长期重复功能迁移}
\rightarrow
\text{拓扑沉降}.\)}
\end{statementbox}
