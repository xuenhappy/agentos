...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.38\textheight,keepaspectratio]{images/intelligence-phase-map.png}
\caption{集中度与拓扑可塑度构成的智能相图}
\end{figure}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Learning
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LocalIntelligence
\leftrightarrow
AdaptiveTopology
\leftrightarrow
GlobalConstraint.\)}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.6\textheight,keepaspectratio]{images/cognitive-cosmos-artwork.png}
\caption{智能相动态化的技术巅峰意向图}
\end{figure}
