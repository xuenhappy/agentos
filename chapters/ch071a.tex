...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \textbf{能力不必是模块，能力往往是动力学。}\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ObservedPhenomenon
\Rightarrow
InventedModule.\)}
\end{statementbox}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.38\textheight,keepaspectratio]{images/cabel-used.png}
\caption{AgentOS的模块涌现认知原理示意图}
\end{figure}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathcal M_{\mathrm{base}}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathcal V_{\mathrm{slow}}
=
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \pi^\ast
:
SituationCSO
\rightarrow
ControlPattern.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Planning
\leftrightarrow
Strategy
\leftrightarrow
Skill.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Process(C\rightarrow C')
\rightarrow
AgentCSO(Process).\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SpatialRelationComplexity
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ObservedCapability
\nRightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle EmergentCapability
\rightarrow
StablePattern
\rightarrow
CompiledSkill.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle DynamicCoordination
\rightarrow
StructuralCapital.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle EmergentBehavior
\rightarrow
RepeatedPattern
\rightarrow
StablePolicy
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Phenomenology
\not\Rightarrow
Architecture.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle EmergentCognition
\Rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle EmergentPattern
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Emergence
\rightarrow
Stabilization
\rightarrow
Compilation
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Skill
\rightarrow
Residual
\rightarrow
ReCognition
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Capability
\rightarrow
Module\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Mechanism
\rightarrow
Dynamics
\rightarrow
Capability.\)}
