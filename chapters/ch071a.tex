...
\[
\boxed{
\text{Capability is not necessarily a Component; Capability is often a Dynamical Regime.}
}
\]
...
\[
\boxed{
\text{Agent 对新现实进行解释、预测和结构化时表现出的长期稳定生成偏置。}
}
\]
...
\[
\boxed{
\text{Minimal Mechanism, Maximal Emergence Principle}.
}
\]
...
\[
\boxed{
\text{只有无法由已有基础动力学稳定产生、并且确实需要独立状态、权限、时间尺度或 ABI 的功能，才应被物化为显式模块。}
}
\]
...
\[
\boxed{
\text{高级能力与显式机制数量之间的比例值得成为架构评价对象。}
}
\]
