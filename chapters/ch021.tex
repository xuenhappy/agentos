...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Theory
\rightarrow
Prediction
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle World\leftrightarrow Civilization\)}
\end{statementbox}
耦合带宽。
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle RepeatedCSOFlow
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SlowCivilizationalStructure
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PersistentIndividualResidual
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Cognition
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle AI\text{ 在文明功能拓扑中将成为哪一种认知层？}\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Observe\rightarrow Model\rightarrow Predict\rightarrow Act\rightarrow Reorganize\)}
\end{statementbox}
链路的速度和带宽。
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ModificationPower
\not\Rightarrow
Maturity.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Understanding
\uparrow,
\qquad
ActionCapacity
\uparrow,
