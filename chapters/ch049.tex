...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle OnePersistentSubject
\not\Rightarrow
OnePhysicalBody.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle BodyHistory
\rightarrow
Experience
\rightarrow
SelfDevelopment.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle HighLevelIntent
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Intent
\rightarrow
CursorAction
\rightarrow
GUIReality
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LocalNormalDynamics
\rightarrow
LocalClosure,\)}
\end{statementbox}
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PersistentRelevantResidual
\rightarrow
GlobalCognition.\)}
\end{statementbox}
反方向则是：
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle StableHighLevelSkill
\rightarrow
LowerLevelExecution.\)}
\end{statementbox}
