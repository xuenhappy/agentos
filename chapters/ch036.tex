...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle InternalState
\rightarrow
SPC
\rightarrow
AHC
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FunctionalExperience
\Rightarrow
SelfAccessibility
+
TemporalContinuity
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle DistributedSystemState
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SelfDescription
\rightarrow
SelfModulation.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle InternalExperience
\rightarrow
PersonalEpisode.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle InternalSignal
\rightarrow
SelfState
\rightarrow
InternalExperience
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FastState
\rightarrow
MidScaleExperience
\rightarrow
SlowSelfConstraint.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ReactiveRegulation
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle InternalDynamics
\rightarrow
SelfPerception
\rightarrow
Experience
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathcal E_A[t_0,t_1]
=
\left[
InternalState
\rightarrow
