...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{State}
\rightarrow
\text{Trajectory}
\rightarrow
\text{Generator}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Self
\rightarrow
Structure
\rightarrow
EpisodeSelection
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle E(t)
=
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \Theta(t)
=
