...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Training}
=
\text{对某种能力生成机制进行优化}\)}
\end{statementbox}
而
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Cultivation}
=
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Environment
\rightarrow
Experience
\rightarrow
Structure
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathcal A_t
\xrightarrow{
Experience
}
\mathcal A_{t+1}
