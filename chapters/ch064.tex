...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SafetyResidual
\rightarrow
CognitiveLearning.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SemanticPrecaution
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FreeRegion
\rightarrow
CautionRegion
\rightarrow
ConstraintRegion
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SafetyEnvelope
\rightarrow
FCS
\rightarrow
Cognition\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \textbf{Principle 1:}\quad
CriticalSafety\nrightarrow CognitiveDependency\)}
\end{statementbox}
