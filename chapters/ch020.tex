...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.38\textheight,keepaspectratio]{images/cosmic-intelligence-structure.png}
\caption{结构自表示参与调节的功能自反}
\end{figure}
\section{从结构到关于结构的结构}
...
\begin{statementbox}
Universe contains a physical structure that represents part of Universe.
\end{statementbox}
...
\begin{statementbox}
宇宙中的一个局部子系统形成了关于自身部分状态的可操作压缩表示。
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SelfReflexivity
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LocalUniverse
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FunctionalReflexivity
\nRightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle UniverseLocalState
\rightarrow
...
\begin{statementbox}
宇宙内部出现了能够形成关于宇宙及自身局部结构的内部表示，并使这些表示参与未来现实变化的子系统。
\end{statementbox}
