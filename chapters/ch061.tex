...
本章给出的回答可以浓缩为两条互补原则：
\[
\boxed{\text{Predict Locally,\ Escalate Residual Globally}}
\]
以及
\[
\boxed{\text{Stable Ability Moves Downward,\ Unexpected Residual Moves Upward}}
\]
...
\begin{equation}
\boxed{
\text{Each Scale Should Predict and Close What It Can Locally.}
}
\end{equation}
...
\[
\boxed{
\text{Higher intelligence should govern local intelligence,
not replace it.}
}
\]
...
\begin{equation}
\boxed{
\text{Stable Ability Moves Downward.}
}
\end{equation}
...
\[
\boxed{
\text{Attention is partly a policy for promoting unresolved structure across scales.}
}
\]
...
\begin{equation}
\boxed{
\text{Adjacent Scale Coupling Principle}
}
\end{equation}
