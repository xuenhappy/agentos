...
\[
\boxed{
\parbox{.86\linewidth}{\centering\bfseries 第一，智能的组织基础不是模块，而是功能及其闭环关系。}
}
\]

\[
\boxed{
\parbox{.86\linewidth}{\centering\bfseries 第二，模块是长期稳定功能关系在实现层形成的拓扑凝聚。}
}
\]

\[
\boxed{
\parbox{.86\linewidth}{\centering\bfseries 第三，功能拓扑是认知结构能够被承载、迁移并最终改变智能自身组织方式的结构基础。}
}
\]
