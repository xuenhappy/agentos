...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle HighDimensionalCognitiveDynamics
\longrightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FSS
\rightarrow
AttentionBias
\rightarrow
EvidenceBias
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ObserverCalibration
\rightarrow
