...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle StableAgentCSO
\rightarrow
FastLocalCarrier.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LocalDeterminism
\Rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FastResidual
\rightarrow
LocalAdaptation
\rightarrow
PersistentResidual
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle CognitiveMigration
\Rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle InferenceChip
\leftrightarrow
AgentKernel\)}
\end{statementbox}
负责高维、语义、生成和较慢结构计算；
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle CerebellumChip
\leftrightarrow
BodyRuntime/BPCC\)}
\end{statementbox}
