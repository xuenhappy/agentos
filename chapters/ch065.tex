...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathrm{KRA}
=
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SlowIntent
\rightarrow
FastLocalClosure\)}
\end{statementbox}
以及
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ExplicitCognitiveIntervention\downarrow
\quad
\text{while}
\quad
TaskSuccess\uparrow.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LatentChannel
\not\Rightarrow
SemanticAuthority.\)}
\end{statementbox}
