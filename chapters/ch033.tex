...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SPC\rightarrow TCE\rightarrow CognitiveDynamics\rightarrow SPC\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle CurrentSelfState
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LocalCorrectProjection
\Rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FirstOrder:
World\rightarrow Cognition\rightarrow Action\)}
\end{statementbox}
而：
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SecondOrder:
...
\begin{statementbox}
形成关于自身认知状态的可操作表示，并依据该表示改变自身后续认知动力学的能力。
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ObserveSelf
\rightarrow
EvaluateState
\rightarrow
ModifyDynamics
