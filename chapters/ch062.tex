...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathrm{Explicit\ Agent\mbox{-}CSO}
\longrightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathrm{Explicit\ Cognitive\ Control}
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathrm{Repetition}
\neq
\mathrm{Skill};
\qquad
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathrm{Procedural}
\leftrightarrow
\mathrm{Explicit}.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathrm{ProceduralAgentCSO}
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle NovelProblem
\rightarrow
ExplicitCognition
\rightarrow
Experience
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle RepeatedExperience
\rightarrow
StableStructure.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle StableStructure
\rightarrow
LocalExecutableLoop.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle UnexpectedResidual
\rightarrow
