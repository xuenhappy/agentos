...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Microstate
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ManyFastMicroscopicDegrees
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LowScaleCSOs
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PhysicalMacrostructure
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PossibleStructure
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PhysicalFeedback
\rightarrow
HomeostaticFeedback
\rightarrow
SensorimotorControl
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Matter
\rightarrow
SelfOrganization
\rightarrow
SelfMaintenance
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle FastCollectiveActivity
\rightarrow
HistoricalRecord
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PhysicalStructure
\leftrightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Knowledge
\rightarrow
Tool
\rightarrow
NewObservation
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle PhysicalDynamics:
\quad
Structure
\rightarrow
Structure'\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ReflexiveDynamics:
\quad
Structure
\rightarrow
Representation
