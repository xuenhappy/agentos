...
\caption{Kernel 与 Body Runtime 的状态空间分工}
\end{figure}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle BodyState
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle LowLevelControl
\rightarrow
HighLevelAffordance.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle MatureAbility
\Rightarrow
