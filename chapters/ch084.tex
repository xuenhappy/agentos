...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ModelCorrectness
\not\Rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle CapabilityGrowth
\not\Rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Experience Design}
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Control Engineering}
\rightarrow
\text{Stability},\)}
\end{statementbox}
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Cultivation Engineering}
\rightarrow
\text{Development},\)}
\end{statementbox}
\begin{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathbf J_A
\text{ 是否保持在可治理流域中；}\)}
\end{statementbox}
培育工程关心的是：
\begin{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \rho_A,\mathbf J_A
