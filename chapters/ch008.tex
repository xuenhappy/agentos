...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.38\textheight,keepaspectratio]{images/intelligence-capability-comparison.png}
\caption{语义、功能、时间与拓扑原语的能力比较}
\end{figure}
...
改变成：
\begin{statementbox}
Which generative structure can continually produce suitable future architectures?
\end{statementbox}
...
\begin{proposition*}
生成复杂结构最有效的方式，可能不是存储最终结构，而是存储产生结构的规则。
\end{proposition*}
