...
\[
\boxed{
\text{Same Dynamic Form,\ Different State Space,\ Different Timescale}
}
\]
...
\[
\boxed{
\text{这些闭环如何局部闭合、向上反馈、向下约束并共同改变长期结构。}
}
\]
