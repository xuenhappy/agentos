...
\begin{statementbox}
先验证统一的主体动力学，再逐步扩大身体；先闭合低风险现实，再进入高代价现实。
\end{statementbox}
\end{chapteroverviewbox}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.38\textheight,keepaspectratio]{images/multi-body-evolution-loop.png}
\caption{多身体环境中的现实闭环与进化搜索}
\end{figure}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle World\rightarrow Body\rightarrow AgentKernel
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \frac{\partial \mathrm{Architecture}_{Agent}}
{\partial B_i}
\rightarrow 0\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{ClosedLoopCorrectness}
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle DesktopScale\uparrow
\not\Rightarrow
hScale\uparrow\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Mind\rightarrow Program\rightarrow World
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle CSOOntology
\rightarrow
AgentCSO
\rightarrow
BodyGrounding.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle DigitalBody
\rightarrow
Browser
\rightarrow
Desktop/Shell
