...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SwarmOS
\rightarrow
Potential
\rightarrow
SFPU
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SwarmStructure
\rightarrow
SwarmSensation
\rightarrow
LocalCognition
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Prediction\ Error
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Potential
\rightarrow
Gradient
\rightarrow
FCS
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{发布}
\rightarrow
\text{预下载}
\rightarrow
\text{影子推理}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Structural\ Constraint
\rightarrow
Local\ Dynamics
\rightarrow
State\ Evolution.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Swarm
\rightarrow
Agent
\rightarrow
World
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Individual\ State
\rightarrow
Collective\ Field.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle MacroStructuralConstraint
+
MicroAutonomy
\rightarrow
CollectiveEmergence.\)}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{群体结构约束}
\rightarrow
\text{个体结构感受}
\rightarrow
\text{本地自主决策}
