...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle AgentKernel=\text{决定做什么与为什么做}\)}
\end{statementbox}
...
\caption{Body Runtime 的研发组件与接口关系}
\end{figure}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SemanticTimescale
\longrightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle BodyABI
\rightarrow
SGC
\rightarrow
FCS
