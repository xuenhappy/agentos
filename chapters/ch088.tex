...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \hat x_c(t)
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle T
=
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Representation}
\rightarrow
\text{Commitment}\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle ReduceGain
\rightarrow
ReduceConcurrency
\rightarrow
NarrowActiveSet
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \begin{minipage}{0.90\textwidth}
\textbf{TCE 控制器原理：}
