...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Prediction}
\rightarrow
\text{Action}
\rightarrow
\text{Observation}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \text{Fourier Intuition}
\rightarrow
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SlowConstraint
\downarrow
\qquad
PersistentResidual
\uparrow\)}
