...
\[
\boxed{
\parbox{.86\linewidth}{\centering\bfseries 智能同类性的研究对象不是材料，而是跨实现仍然保持的认知组织关系。}
}
\]
...
\[
\boxed{
\text{Cognitive Dynamical Equivalence}
}
\]
也就是认知动力学等价。
...
\[
\boxed{
\text{两个系统在哪些Semantic Classes中具有多高程度的结构等价？}
}
\]
...
\[
\boxed{
\text{两个系统是否都存在从快速当前状态到较慢经验结构，再到长期生成结构的迁移？}
}
\]
如果存在，则可以比较：
\[
...
\[
\boxed{
\text{在给定认知语义类中，人脑与人工系统是否存在可识别的多尺度动力学映射？}
}
\]
