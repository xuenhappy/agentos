...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle World\rightarrow Representation.\)}
\end{statementbox}
它关心现实结构如何被 Agent 描述。
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle World\times Agent\rightarrow FunctionalInfluence.\)}
\end{statementbox}
它关心同一现实相对于当前主体意味着什么。
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle \mathcal R_A(t)
=
