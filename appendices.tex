...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Reality\;CSO
\rightarrow
Agent\mbox{-}CSO
\rightarrow
Functional\;Carrier
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle SGC=\text{经验内容},
\qquad
FCS=\text{经验作用}.\)}
\end{statementbox}
...
\begin{statementbox}
\centering
\adjustbox{max width=.96\linewidth}{\(\displaystyle Capability\uparrow
\nRightarrow
Authority\uparrow\)}
\end{statementbox}
