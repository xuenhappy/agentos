...
$$
\boxed{
\text{认知结构在表示、功能位置、时间尺度和内外载体之间的迁移。}
}
$$
...
$$
\boxed{
\text{一个拓扑基本固定的智能体，如何仅通过多尺度状态、记忆和控制动力学成为持续主体。}
}
$$
...
$$
\boxed{
\parbox{.86\linewidth}{\centering 宇宙内部已经产生能够形成关于宇宙局部和自身的结构表示，并依据这些表示改变现实的子系统。}
}
$$
...
$$
\boxed{
\parbox{.86\linewidth}{\centering\bfseries 智能动力学——一门研究智能如何流动、稳定、迁移、成长和改变自身结构的科学。}
}
$$
